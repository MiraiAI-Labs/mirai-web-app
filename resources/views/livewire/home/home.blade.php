...
<div class="drawer-content-container">
    ...
    @else
        ...
        <section class="mt-4" x-data="job_analysis" wire:poll="pollFetched">
            ...
            <div class="bg-base-100 rounded-xl flex justify-center items-center min-h-80 p-12 flex-col items-center" x-show="fetched">
                <canvas class="w-full h-full" id="wordcloud"></canvas>
            </div>
        </section>
    @endif
</div>
...
@section('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            let wordcloud_data = {!! json_encode(array_slice($analysis_json["wordcloud_data"], 0, 200) ?? []) !!};
            ...
            const sampleKeys = Object.keys(wordcloud_data);
            const sampleValues = Object.values(wordcloud_data);
            ...
            new window.Chart(ctx, {
                type: window.WordCloudController.id,
                data: chartData,
                options: options
            });
        });
